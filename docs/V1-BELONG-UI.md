...
(Design addendum, v2 after user research: ten simulated reviewers, 6 Sep 2026; rebuilt from the recorded decisions after the v1 branch was lost)

Owner: Code as interim Cards, drafted from rendered mockups and the ten-reviewer round; for Jib's approval  
