...
| File | What it shows |
|---|---|
| `phone-start-fold.png` / `wide-start-fold.png` | First fold: subline, search, all three pictured doors |
| `phone-start.png` / `wide-start.png` | Full Start: visitor titles, box/card art, learn line |
...
Forty live-site reviews: `docs/review/lenses/reviews/`. Spec: `docs/V1-CUSTOMER-LENSES-UI.md`.
